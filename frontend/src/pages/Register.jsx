            ...
            <div className="w-full max-w-md space-y-8">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-400">
                        Start trading with TradeX today
                    </p>
                </div>

                <Card className="mt-8 space-y-6 shadow-lg border-gray-800 bg-groww-card">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        {error && (
                            <div className="bg-red-500/10 text-red-400 border border-red-500/20 p-3 rounded-lg text-sm flex items-center">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-groww-card text-gray-500">
                                or continue with
                            </span>
                        </div>
                    </div>
                ...
                <p className="mt-2 text-center text-sm text-gray-500">
                    ...
                    <Link to="/login" className="font-medium text-groww-primary hover:text-indigo-400">
                        Sign in
                    </Link>
                </p>
            </div>
